...
public:
	...
	virtual bool initialize(const shared_ptr<app_contextable>& context, const size_t width, const size_t height) = 0;
...
public:
	...
	bool initialize(const shared_ptr<app_contextable>& context, const size_t width, const size_t height) override;
...
protected:
	...
	shared_ptr<app_contextable> context_;
